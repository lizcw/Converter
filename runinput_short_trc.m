...
inputfile = './InputData/trc_converted.mat';
trajectoryfield = 'finalTraj';

% Computing strategy
parallelize_config = false;
...
parallel_end = 'delete(gcp(''nocreate''))'; % executed after the parallelizable loop.

% Saving options
%outputfile = './Results/testresult_vbSPT_HMM_short.mat';
outputfile = './Results/trc_converted_results.mat';
